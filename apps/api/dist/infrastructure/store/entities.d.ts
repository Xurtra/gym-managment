import type { AccessDeviceStatus, AccessDeviceType, AccessEventDecision, BillingInterval, BookingSource, BookingStatus, CheckInMethod, CheckInStatus, ClassSessionStatus, FeatureFlag, GymStatus, LocationStatus, MemberStatus, MembershipStatus, NotificationEventStatus, NotificationEventType, Permission, PlanStatus, RoleName, StaffAuditAction, StaffInviteStatus, UserStatus } from "@gym-platform/constants";
...
export type OperatingHours = Partial<Record<"mon" | "tue" | "wed" | "thu" | "fri" | "sat" | "sun", HoursRange[]>>;
