...
describe("ClassScheduleService", () => {
    it("creates class types, schedules class sessions, and exposes public sessions", async () => {
        ...
        const schedule = await services.classScheduleService.publicSchedule(gymSlug, new Date("2026-05-18T00:00:00.000Z"), new Date("2026-05-19T00:00:00.000Z"));
        const filteredSchedule = await services.classScheduleService.publicSchedule(gymSlug, new Date("2026-05-18T00:00:00.000Z"), new Date("2026-05-19T00:00:00.000Z"), { locationId });
    ...
    it("rejects invalid session times and trainers outside the gym", async () => {
        ...
        await expect(services.classScheduleService.createSession(gymId, {
...
async function createGymWithLocation(services) {
...
//# sourceMappingURL=classSchedule.service.test.js.map