...
describe("TenancyService", () => {
    ...
    it("rejects access to gyms outside the user's memberships", async () => {
        ...
        await expect(services.tenancyService.ensureGymAccess(outsider.user.id, owner.gym?.id ?? "")).rejects.toThrow(/does not have access/i);
    });
...
//# sourceMappingURL=tenancy.service.test.js.map