...
export function buildStaffListPage(inputModel: {
  ...
  const filters: StaffListPage["filters"] = {
    query,
...
function buildStaffListRow(
  staff: StaffMemberView,
  options: {
    role: StaffRoleOption | undefined;
...
function matchesFilters(
  staff: StaffMemberView,
  filters: StaffListPage["filters"],
  roleLookup: Map<string, StaffRoleOption>
) {
...
function compareStaff(left: StaffMemberView, right: StaffMemberView) {
...
function buildEmptyState(filtered: boolean) {
  return emptyState({
