...
describe("location dashboard logic", () => {
  ...
  it("builds archived detail state with archive disabled and empty scoped modules", () => {
    const archivedDetail = buildLocationDetailPage({
      location: locations[2] as LocationView,
      rooms,
      accessRules
    });
  ...
  it("builds empty location list state and falls back to the first active selection", () => {
    const archivedOnly = buildLocationListPage([locations[2] as LocationView], "missing");
  ...
  it("builds dashboard and public schedule location switchers", () => {
    ...
    const emptyDashboard = buildDashboardLocationSwitcher([locations[2] as LocationView]);
    ...
    const emptyPublicSchedule = buildPublicScheduleLocationSwitcher([locations[2] as LocationView]);
