...
import {
  ...
  buildCheckInResultScreen,
  buildFrontDeskCheckInScreen,
  buildMemberSearchScreen,
  buildQrScannerScreen,
  createBarcodeCheckInSubmission,
  createManualCheckInSubmission,
  createQrCheckInSubmission,
  exportCheckInHistoryCsv,
  shouldResetKiosk,
  warningForMember
} from "./index.js";
import type { CheckInRecord, MemberSearchResult } from "./index.js";
...
const allowedRecord: CheckInRecord = {
  id: "check-in-1",
  memberId: "member-1",
...
const deniedRecord: CheckInRecord = {
  id: "check-in-2",
  memberId: "member-2",
...
describe("check-in dashboard screens", () => {
  ...
  it("builds success, denied, and payment warning result states", () => {
    ...
    expect(warningForMember(members[1] as MemberSearchResult)).toBe("Payment past due");
  });
