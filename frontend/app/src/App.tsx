...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/dashboard/locations" element={<LocationsRoute />} />
      <Route path="/dashboard/plans" element={<PlansDomainRoute />} />
      ...
      <Route path="/dashboard/training" element={<TrainingRoute />} />
      <Route path="/dashboard/contracts" element={<FormsRoute />} />
      <Route path="/dashboard/portal" element={<PortalRoute />} />
      <Route path="/dashboard/marketing" element={<MarketingRoute />} />
