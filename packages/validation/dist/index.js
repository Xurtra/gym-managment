import { AccessDeviceType, BillingInterval, CheckInMethod, ContactPreference, InteractionType, InterestLevel, LeadSource, LeadStage, FeatureFlag, ReservationConfirmationMode, ReservationPaymentRequirement, MemberStatus, MembershipStatus, Permission, RetentionFlag, RoleName } from "@gym-platform/constants";
import { z } from "zod";
...
export const schedulerGenerateSchema = schedulerGenerateBaseSchema.refine((value) => !value.endsOn || value.endsOn >= value.startsOn, {
