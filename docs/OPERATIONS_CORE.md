...
The dashboard member-management layer in `apps/dashboard/src/members` now covers:
...
The dashboard leads-and-CRM layer in `apps/dashboard/src/leads` now covers:
...
The dashboard membership-plan layer in `apps/dashboard/src/membershipPlans` now covers:
...
The dashboard contracts-and-waivers layer in `apps/dashboard/src/contractsWaivers` now covers:
...
The dashboard Stripe-payments layer in `apps/dashboard/src/payments` now covers:
...
The dashboard bookings-and-waitlists layer in `apps/dashboard/src/bookings` now covers:
...
The dashboard personal-training layer in `apps/dashboard/src/personalTraining` now covers:
...
The dashboard check-in layer in `apps/dashboard/src/checkIns` now covers:
...
The dashboard access-control layer in `apps/dashboard/src/accessControl` now covers:
...
The public website layer in `apps/website-renderer/src` now covers:
